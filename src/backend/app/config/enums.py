...
class SmsTemplate(StrEnum):
    ...
    LA_1_HOUR_AFTER_REG_TOMORROW = "We’re going live tomorrow at 3 PM PT / 6 PM ET. You’ll see the Russian Manicure process on a real model and learn what affects retention, speed, and clean results."
    ...
    LA_4_HOURS_BEFORE = "Reminder: live Russian Manicure webinar today 3 PM PT / 6 PM ET. RM, Hard Gel, Dual Forms & $100+ services. Join: https://start.bizon365.ru/room/ybprofessional/veb27"
    LA_3_HOURS_BEFORE = "We’re going live in 3 hours. See the Russian Manicure process on a real model and learn what causes lifting, bulky shape, and inconsistent results. Save the time: 3 PM PT / 6 PM ET."
    LA_2_HOURS_BEFORE = "We’re going live in 2 hours. Save the time: 3 PM PT / 6 PM ET."
    LA_1_HOUR_BEFORE = "Starting in 1 hour. Today at 3 PM PT / 6 PM ET Yuliya will show Russian Manicure + Dual Forms process videos. Join: https://start.bizon365.ru/room/ybprofessional/veb27"
    LA_10_MINUTES_BEFORE = "We’re starting in 10 minutes. Join here: https://start.bizon365.ru/room/ybprofessional/veb27"
    LA_START = "We’re LIVE now. Join the Russian Manicure webinar here: https://start.bizon365.ru/room/ybprofessional/veb27"
    LA_10_MINUTES_AFTER_START = "We’re already inside the live demo. Join now to see clean cuticle work, proper prep, and how to avoid lifting: https://start.bizon365.ru/room/ybprofessional/veb27"
    LA_AFTER_WEBINAR = "Thank you for joining the webinar 💅 Your special offer is open: get the Complete Nail System for $399 instead of $787. Enroll here: https://cf.ybcourses.online/learnrussian-manicure?utm_source=web_email"
    LA_AFTER_WEBINAR_2 = "Ready to stop guessing and start working with a real system? Russian Manicure + Hard Gel + Dual Forms are now available in one package for $399 instead of $787. Join here: https://cf.ybcourses.online/learnrussian-manicure?utm_source=web_email"
    LA_1_DAY_AFTER_WEB = "Reminder: your webinar discount is still active. Get the full combo course for $399 instead of $787 and learn the system behind $100–150 nail services. Secure your access: https://cf.ybcourses.online/learnrussian-manicure?utm_source=web_email"
    LA_2_DAYS_AFTER_WEB = "Last chance to get the Complete Nail System for $399 instead of $787. After the offer closes, the regular price returns. Join now: https://cf.ybcourses.online/learnrussian-manicure?utm_source=web_email"
